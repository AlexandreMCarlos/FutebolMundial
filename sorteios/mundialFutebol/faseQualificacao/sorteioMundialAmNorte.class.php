...
Class sorteioMundialAmNorte{
		
	public $prefixoConf = 'MAN';
	protected $idConf = 3;	

	public $prefixoFase = array('MAN_01', 'MAN_02', 'MAN_03');
	...
	* Acção: Vai dar inicio ao sorteio da fase de qualificação para o Mundial de Futebol (Zona Norte Americana) 
