...
Class sorteioMundialAfrica{
		
	public $prefixoConf = 'MAF';
	protected $idConf = 2;	

	public $prefixoFase = array('MAF_01', 'MAF_02', 'MAF_03');
	...
	* Acção: Vai dar inicio ao sorteio da fase de qualificação para o Mundial de Futebol (Zona Africana) 
