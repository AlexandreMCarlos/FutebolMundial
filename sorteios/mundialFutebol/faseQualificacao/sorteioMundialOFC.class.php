...
Class sorteioMundialOFC{
	public $prefixoConf = 'MOC';
	protected $idConf = 5;	

	public $prefixoFase = array('MOC_01', 'MOC_02');
	...
	* Acção: Vai dar inicio ao sorteio da fase de qualificação para o Mundial de Futebol (Zona Oceânia) 
	...
	*/
	Function funSorteiaGrupos($varEquipas, $faseSorteio){
        ...
        $varPotes = array_chunk($varEquipas, 2);
